...
#    Updated: 2024/07/16 11:44:11 by Jskehan          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC_PARS = parser.c prompt.c parser_utils.c expand_vars.c tokenization.c \
	set_redir_utils.c
SRC_EXEC = execution.c redirection.c here_doc.c error.c signal.c node_utils.c builtin_functions.c builtin_utils.c
